...
- Registrar salida como pantalla propia en `/salidas`: pide solo la matrícula, busca la sesión activa por coincidencia exacta y abre el diálogo de cobro ya resuelto. Se llega desde la navegación lateral y desde el dashboard (D-031).
